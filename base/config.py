...
__C.DATASET.NAME = "HMDB51"     # The name of Dataset
...
__C.TRAIN = edict()
__C.TRAIN.EPOCHS = 60            # The number of Epoch
...
__C.TRAIN.LR_STEPS =[20,40]      # If LR_SETP_TYPE = 'step', the change step of the learning rate
