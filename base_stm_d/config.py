...
# __C.USE_DISTRIBUTED = True         # TODO: If you set it, the training will use DistributedDataParallel.
# __C.USE_SYNC_BN = False #True if __C.USE_DISTRIBUTED else False # If and only if USE_DISTRIBUTED is set True, it be marked True
...
# __C.EXP_TAG = 'sv2_stm50_RGB_d'     # TODO: the flag of experiment
# __C.BACKBONE = 'stm50'       # TODO: backbone network ['BNInception','mobilenetv2','resnet50','mfnet2d','inceptionv3']
...
# __C.SNAPSHOT_ROOT = "/mnt/lustre/fengjinyuan/data/"        # To set root path which saves output of framework
...
# #                   |-MetafileOrg/
# __C.DATASET = edict()
# __C.DATASET.ROOT_PATH = "" # The root path of Dataset
# __C.DATASET.NAME = ""     # The name of Dataset
...
# __C.DATASET.TRAIN_META_PATH = '/mnt/lustre/fengjinyuan/data/datasets/somethingv2/somethingv2_rgb_train.txt'  #os.path.join(__C.DATASET.ROOT_PATH,__C.DATASET.NAME,'MetafileSeq','train_split1.csv')
# __C.DATASET.VAL_META_PATH = '/mnt/lustre/fengjinyuan/data/datasets/somethingv2/somethingv2_rgb_val.txt' #os.path.join(__C.DATASET.ROOT_PATH,__C.DATASET.NAME,'MetafileSeq','val_split1.csv')
...
# with open("./exps/stm_anet_untrimmed_f8_config.json", 'r') as f:
#     d = json.load(f)
#
# __C = edict(d)
# __C.TIMESTAMP = time.strftime("%Y_%m_%d_%H:%M:%S", time.localtime()) # To initialize timestamp when importing this file
...
if __name__ == '__main__':
    pass
    # #### generating config.json by __C.__dict__
    # with open("./exps/base_config.json",'w') as f:
    #     d = json.dump(__C.__dict__, f,sort_keys=False, indent=4)
