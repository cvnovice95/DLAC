...
def init_from_dict(net, state_dict, strict=False):
    print("Initializer:: loading from `state_dic', strict = {} ...".format(strict))
    ...
    if strict:
        ...
        if net_state_keys:
            print("Initializer:: failed to load: \n{}".format(
                         json.dumps(net_state_keys, indent=4, sort_keys=True)))


def init_3d_from_2d_dict(net, state_dict, method='inflation'):
    print("Initializer:: loading from 2D neural network, filling method: `{}' ...".format(method))
    ...
    if src_state_keys:
        ...
        print("Initializer:: >> {} params are unused: {}".format(len(src_state_keys),
