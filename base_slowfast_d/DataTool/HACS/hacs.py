...
train_label_org_path = '/mnt/lustre/fengjinyuan/data/datasets/HACS/hacs_segments_untrimmed_train_org.txt'
val_label_org_path = '/mnt/lustre/fengjinyuan/data/datasets/HACS/hacs_segments_untrimmed_val_org.txt'
_video_seq_path = '/mnt/lustre/fengjinyuan/data/datasets/HACSSegmentsSeq/'
